...
var ScanPage = /** @class */ (function () {
    ...
    ScanPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-scan',template:/*ion-inline-start:"/Users/jc/Desktop/FYP/Crestron-joseph_build/CrestronMobileApp/src/pages/scan/scan.html"*/'<ion-content class=bg>\n  <img style="display: block;\n      margin-left: auto;\n      margin-right: auto;\n      position: relative;\n      top:100px;" src="assets/imgs/scanwhite.png" />\n  <div text-center>\n    <p class="a">Scan QR Code to proceed</p>\n  </div>\n  <button class="b" style="display: block;\n  margin-left: auto;\n  margin-right: auto;\n  position: relative;\n  top:150px;" ion-button color=light round outline (click)="scanCode()">\n    SCAN\n  </button>\n</ion-content>\n'/*ion-inline-end:"/Users/jc/Desktop/FYP/Crestron-joseph_build/CrestronMobileApp/src/pages/scan/scan.html"*/,
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/jc/Desktop/FYP/Crestron-joseph_build/CrestronMobileApp/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n<div *ngIf="showSplash" class="splash">\n  <img style="display:block;\n        top:5%;\n        margin-left:auto;\n        margin-right:auto;\n        position:relative;" width="100" height="100" src="assets/imgs/nyplogo.png">\n  <h1 text-center><b>iProjection</b></h1>\n  <h5 text-center>Smart Control</h5>\n  <div class="spinner"></div>\n\n  <div class="spinner">\n    <div class="rect1"></div>\n    <div class="rect2"></div>\n    <div class="rect3"></div>\n    <div class="rect4"></div>\n    <div class="rect5"></div>\n  </div>\n\n</div>\n\n'/*ion-inline-end:"/Users/jc/Desktop/FYP/Crestron-joseph_build/CrestronMobileApp/src/app/app.html"*/
        }),
...
var ProjectorApiProvider = /** @class */ (function () {
    ...
    ProjectorApiProvider.prototype.getSystemStatus = function (RoomNum) {
        return this.http.get("https://fusion.sit.nyp.edu.sg/Fusion/apiservice/rooms/" + RoomNum + "&auth=Crestron1%200BF34A53-3DD3-438D-B88F-BEC77EAB3009");
    };
...
var GeneralControlPage = /** @class */ (function () {
    function GeneralControlPage(app, platform, navCtrl, navParam, alertCtrl, toastCtrl, remoteCtrlService, authenticationService, ProjectorApiService, geolocation, hotspot, networkInterface, idle, localNotifications, diagnostic, openNativeSettings, loadingCtrl, backgroundMode, viewCtrl) {
        ...
        this.systemStatus = this.navParam.get('systemStatus');
        this.checked = false;
    ...
    GeneralControlPage.prototype.getSystemStatus = function () {
        var _this = this;
        if (!this.platform.is('cordova')) {
    ...
    GeneralControlPage.prototype.onChangeProjector = function () {
    ...
    GeneralControlPage.prototype.onChangeScreen = function () {
